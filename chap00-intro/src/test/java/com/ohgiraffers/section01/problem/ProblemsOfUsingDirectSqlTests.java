...
// JUnit5에서 제공하는 애너테이션과 클래스를 가져옵니다.
...
class ProblemsOfUsingDirectSqlTests {
    // 데이터베이스 연결을 위한 Connection 객체를 선언합니다.
    private Connection con;

    // 각 테스트 메서드가 실행되기 전에 실행되는 메서드입니다.
    @BeforeEach
    void setConnection() throws ClassNotFoundException, SQLException {
        // MySQL 드라이버의 이름을 지정합니다.
        String driver = "com.mysql.cj.jdbc.Driver";
        // 데이터베이스 URL을 지정합니다. (오타가 있습니다: "locahost" -> "localhost")
     ...
     * 4. 동일성 보장 문제
     * */
    // 1. 데이터 변환 , sql 작성 ,jdbc api 코드 등 중복 작성(개발 시간 증가, 유지보수성 저하)
